...
begin
  ...
  where camp_day_id = p_new_day_id;
...
begin
  ...
  select count(*)::int into v_taken from public.patients where camp_day_id = p_camp_day_id;
  ...
  return query
  select v_row.id, v_row.reg_no, v_row.full_name, v_row.camp_day_id, v_day.day_date;
end;
$$;
